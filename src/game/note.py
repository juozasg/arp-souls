...
class Note:
    def __init__(self, letter='C'):
        ...
        self.letter = arcade.Text(letter, 0, 0, arcade.color.WHITE, 24, anchor_x="center", anchor_y="center", bold=True, font_name="Kenney Future")
    ...
    def draw(self):
        ...
        self.letter.position = self.center_x + 2, self.center_y
